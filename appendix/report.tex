...
В листинге ниже приведено содержание файла rvs\_laboratories\_10/rvs\_laboratories\_10.cu, который содержит код, выполняющий свертку изображения на GPU с помощью CUDA (лист. \ref{lst:main}).
