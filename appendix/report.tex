...
В листинге ниже приведено содержание файла rvs\_lab\-oratories\_10/rvs\_lab\-oratories\_10.cu, который содержит код, выполняющий свертку изображения на GPU с помощью CUDA (лист. \ref{lst:main}).

\begin{code}    
\caption{Содержание rvs\_laboratories\_10/rvs\_laboratories\_10.cu\label{lst:main}}
\begin{minted}{c++}
#include "wb.h"
...
project(rvs_laboratories_10 LANGUAGES CXX CUDA)
...
add_executable(rvs_laboratories_10 rvs_laboratories_10/rvs_laboratories_10.cu)
\end{minted}
\end{code}
